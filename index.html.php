...
function resetAutoIncrement($pdo) {
    $pdo->exec("SET @num := 0");
    $pdo->exec("UPDATE users SET id = @num := (@num + 1)");
...
/* ✏️ Edit Button Colors */
a.edit {
  background: rgba(0, 114, 255, 0.15);
  box-shadow: 0 0 15px rgba(0, 198, 255, 0.5);
}

/* 🗑️ Delete Button Colors */
a.delete {
